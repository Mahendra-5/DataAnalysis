...
/****** Object:  Table [dbo].[combined_file]    Script Date: 3/1/2024 3:53:15 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[combined_file](
...
select * from dbo.combined_file -- 2390265 rows
...
select * from dbo.combined_file where start_lat is null or start_lng is null or end_lat is null or end_lng is null 
...
-- 2390265 rows affected and there are 2390265 so every row is updated

select count(*) from dbo.combined_file where distMi > 8000 -- checking the no# of rows 
